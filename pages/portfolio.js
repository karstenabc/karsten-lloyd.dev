...
import { Container, Nav, Row } from 'react-bootstrap/Nav';
    ...
    <>
      <Row>
        <div className={styles.viewAll}>
          <Nav.Link href={`/portfolio/${link}`}>View All {title}</Nav.Link>
        </div>
      </Row>
    </>
  );
...
class Portfolio extends Component {
  ...
  render() {
    ...
    const subheading = (
      <>
        My <a href='#languages'>languages</a>, <a href='#experience'>experience</a>,{' '}
        <a href='#projects'>projects</a> and <a href='#education'>education</a>
      </>
    );
    ...
    return (
      ...
      >
        ...
        <Container>
          ...
          <Row>
            <div className='col-12'>{renderPills(languages)}</div>
          </Row>
          <Row>
            <div className='col-12'>{renderPills(frameworks)}</div>
          </Row>
          <Row>
            <div className='col-12'>{renderPills(tools)}</div>
          </Row>
          <br />
