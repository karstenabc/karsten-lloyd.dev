  ...
  for (let screenshot of screenshots) {
    render.push(
      <div className='col-sm-6 col-md-4 col-lg-3 mb-3' key={screenshot.id}>
        <img
          src={'/projects/' + projectName + '/' + screenshot.file}
          alt={screenshot.alt}
  ...
  if (!project.link_download && !privacyPolicy) {
    ...
    if (project.link_download) {
      links.push(
        <li>
          Download:{' '}
          <a href={project.link_download} target='_blank' rel='noopener'>
            Click here
          </a>
        </li>
      );
    ...
    if (privacyPolicy) {
      links.push(
        <li>
          Privacy Policy:{' '}
          <a href={privacyPolicy.link} target='_blank' rel='noopener'>
            Click here
          </a>
        </li>
      );
      ...
      <Layout
        ...
        header={
          <div style={{ backgroundColor: project.colour }}>
            <img
              src={'/projects/' + project.name + '/feature.svg'}
